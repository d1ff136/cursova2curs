...
int main() {
    ...
    //int y1 = 625, x1 = 1250; int y2 = 1875, x2 = 1250;
    
    //int y1 = 813, x1 = 813; int y2 = 1686, x2 = 1686;
    
    int y1 = 1, x1 = 1; int y2 = 2499, x2 = 2499;
    
    //int y1 = 626, x1 = 626; int y2 = 625, x2 = 625;
    ...
    //q.enqueue({ 731, 493, 1 });
   // q.enqueue({ 1, 1, 1 }); //час:
    //q.enqueue({ 2499, 2499, 1 });
    q.enqueue({ y1, x1, 1 });  //час:
    q.enqueue({ y2, x2, 1 }); 
